...
module SunshineConversationsClient
  class ConversationsApi
    ...
    def create_conversation_with_http_info(app_id, conversation_create_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(conversation_create_body)
    ...
    def download_message_ref_with_http_info(app_id, conversation_id, download_message_ref_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(download_message_ref_body)
      ...
      new_options = opts.merge(
        :operation => :"ConversationsApi.download_message_ref",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def post_conversion_events_with_http_info(app_id, conversation_id, conversion_events_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(conversion_events_body)
      ...
      new_options = opts.merge(
        :operation => :"ConversationsApi.post_conversion_events",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_conversation_with_http_info(app_id, conversation_id, conversation_update_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(conversation_update_body)
