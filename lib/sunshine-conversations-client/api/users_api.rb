...
module SunshineConversationsClient
  class UsersApi
    ...
    def create_user_with_http_info(app_id, user_create_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_create_body)
    ...
    def delete_user_personal_information_with_http_info(app_id, user_id_or_external_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"UsersApi.delete_user_personal_information",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def sync_user_with_http_info(app_id, zendesk_id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'sync_user_body'])
    ...
    def update_user_with_http_info(app_id, user_id_or_external_id, user_update_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_update_body)
