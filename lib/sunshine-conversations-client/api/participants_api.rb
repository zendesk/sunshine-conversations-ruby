...
module SunshineConversationsClient
  class ParticipantsApi
    ...
    def join_conversation_with_http_info(app_id, conversation_id, participant_join_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(participant_join_body)

      # return_type
      return_type = opts[:debug_return_type] || 'ParticipantResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"ParticipantsApi.join_conversation",
    ...
    def leave_conversation_with_http_info(app_id, conversation_id, participant_leave_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(participant_leave_body)
      ...
      new_options = opts.merge(
        :operation => :"ParticipantsApi.leave_conversation",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_participants_with_http_info(app_id, conversation_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ParticipantListResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"ParticipantsApi.list_participants",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
