...
module SunshineConversationsClient
  class OAuthEndpointsApi
    ...
    # @param get_token_request [GetTokenRequest] 
    # @param [Hash] opts the optional parameters
    ...
    # @param get_token_request [GetTokenRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetToken200Response, Integer, Hash)>] GetToken200Response data, response status code and response headers
