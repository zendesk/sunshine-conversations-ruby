...
module SunshineConversationsClient
  class SwitchboardActionsApi
    ...
    def accept_control_with_http_info(app_id, conversation_id, accept_control_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(accept_control_body)
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardActionsApi.accept_control",
    ...
    def offer_control_with_http_info(app_id, conversation_id, offer_control_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(offer_control_body)
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardActionsApi.offer_control",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def pass_control_with_http_info(app_id, conversation_id, pass_control_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(pass_control_body)
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardActionsApi.pass_control",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def release_control_with_http_info(app_id, conversation_id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'release_control_body'])
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardActionsApi.release_control",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
