  ...
  class MessagesApi
    ...
    def delete_all_messages_with_http_info(app_id, conversation_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"MessagesApi.delete_all_messages",
    ...
    def post_message_with_http_info(app_id, conversation_id, message_post, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(message_post)

      # return_type
      return_type = opts[:debug_return_type] || 'MessagePostResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"MessagesApi.post_message",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
