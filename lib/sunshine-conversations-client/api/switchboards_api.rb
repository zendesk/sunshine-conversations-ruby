...
module SunshineConversationsClient
  class SwitchboardsApi
    ...
    def create_switchboard_with_http_info(app_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SwitchboardResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"SwitchboardsApi.create_switchboard",
    ...
    def delete_switchboard_with_http_info(app_id, switchboard_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardsApi.delete_switchboard",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_switchboards_with_http_info(app_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SwitchboardListResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"SwitchboardsApi.list_switchboards",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_switchboard_with_http_info(app_id, switchboard_id, switchboard_update_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(switchboard_update_body)
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardsApi.update_switchboard",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
