...
module SunshineConversationsClient
  class AttachmentsApi
    ...
    def delete_attachment_with_http_info(app_id, attachment_delete_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(attachment_delete_body)
      ...
      new_options = opts.merge(
        :operation => :"AttachmentsApi.delete_attachment",
    ...
    def upload_attachment_with_http_info(app_id, access, source, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"AttachmentsApi.upload_attachment",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
