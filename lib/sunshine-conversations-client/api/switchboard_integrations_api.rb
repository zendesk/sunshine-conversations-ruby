...
module SunshineConversationsClient
  class SwitchboardIntegrationsApi
    ...
    def create_switchboard_integration_with_http_info(app_id, switchboard_id, switchboard_integration_create_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(switchboard_integration_create_body)

      # return_type
      return_type = opts[:debug_return_type] || 'SwitchboardIntegrationResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"SwitchboardIntegrationsApi.create_switchboard_integration",
    ...
    def delete_switchboard_integration_with_http_info(app_id, switchboard_id, switchboard_integration_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardIntegrationsApi.delete_switchboard_integration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_switchboard_integrations_with_http_info(app_id, switchboard_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SwitchboardIntegrationListResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"SwitchboardIntegrationsApi.list_switchboard_integrations",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_switchboard_integration_with_http_info(app_id, switchboard_id, switchboard_integration_id, switchboard_integration_update_body, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(switchboard_integration_update_body)
      ...
      new_options = opts.merge(
        :operation => :"SwitchboardIntegrationsApi.update_switchboard_integration",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
