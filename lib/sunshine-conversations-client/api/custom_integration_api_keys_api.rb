...
module SunshineConversationsClient
  class CustomIntegrationApiKeysApi
    ...
    def create_custom_integration_key_with_http_info(app_id, integration_id, integration_api_key, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(integration_api_key)

      # return_type
      return_type = opts[:debug_return_type] || 'IntegrationApiKeyResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"CustomIntegrationApiKeysApi.create_custom_integration_key",
    ...
    def delete_custom_integration_key_with_http_info(app_id, integration_id, key_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CustomIntegrationApiKeysApi.delete_custom_integration_key",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_custom_integration_key_with_http_info(app_id, integration_id, key_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"CustomIntegrationApiKeysApi.get_custom_integration_key",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_custom_integration_keys_with_http_info(app_id, integration_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IntegrationApiKeyListResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['basicAuth', 'bearerAuth']

      new_options = opts.merge(
        :operation => :"CustomIntegrationApiKeysApi.list_custom_integration_keys",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
