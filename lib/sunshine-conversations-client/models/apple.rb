  ...
  class Apple < Integration
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          msp_id == o.msp_id &&
          authentication_message_secret == o.authentication_message_secret && super(o)
    end
    ...
    def hash
      [default_responder_iddefault_respondertypebusiness_idapi_secretmsp_idauthentication_message_secret].hash
    end
