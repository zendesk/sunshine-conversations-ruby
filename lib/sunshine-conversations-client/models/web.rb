  ...
  class Web < Integration
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'integration_order')
        if (value = attributes[:'integration_order']).is_a?(Array)
      ...
      if attributes.key?(:'origin_whitelist')
        if (value = attributes[:'origin_whitelist']).is_a?(Array)
    ...
    def hash
      [default_responder_iddefault_respondertypebrand_colorfixed_intro_paneconversation_coloraction_colordisplay_stylebutton_icon_urlbutton_widthbutton_heightintegration_orderbusiness_namebusiness_icon_urlbackground_image_urlorigin_whitelistprechat_capturecan_user_see_conversation_listcan_user_create_more_conversationsattachments_enabled].hash
    end
