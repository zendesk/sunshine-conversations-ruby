...
module SunshineConversationsClient
  class WebUpdate
    ...
    def hash
      [display_namedefault_responder_idbrand_colorfixed_intro_paneconversation_coloraction_colordisplay_stylebutton_icon_urlbutton_widthbutton_heightintegration_orderbusiness_namebusiness_icon_urlbackground_image_urlorigin_whitelistprechat_capturecan_user_see_conversation_listcan_user_create_more_conversations].hash
    end
