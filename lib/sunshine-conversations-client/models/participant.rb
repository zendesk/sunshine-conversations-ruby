  ...
  class Participant
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'client_associations')
        if (value = attributes[:'client_associations']).is_a?(Array)
          self.client_associations = value
        end
      end
    ...
    def hash
      [iduser_idunread_countclient_associationsuser_external_idlast_read].hash
    end
