...
module SunshineConversationsClient
  class Conversation
    ...
    def hash
      [idtypemetadataactive_switchboard_integrationpending_switchboard_integrationis_defaultdisplay_namedescriptionicon_urlbusiness_last_readlast_updated_atcreated_at].hash
    end
