...
module SunshineConversationsClient
  class Conversation
    ...
    def hash
      [id, type, metadata, active_switchboard_integration, pending_switchboard_integration, is_default, display_name, description, icon_url, business_last_read, last_updated_at, created_at].hash
    end
