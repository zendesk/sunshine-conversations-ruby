...
module SunshineConversationsClient
  class ParticipantWithUserExternalId
    ...
    attr_accessor :subscribe_sdk_client
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SunshineConversationsClient::ParticipantWithUserExternalId` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SunshineConversationsClient::ParticipantWithUserExternalId`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subscribe_sdk_client')
        self.subscribe_sdk_client = attributes[:'subscribe_sdk_client']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscribe_sdk_client == o.subscribe_sdk_client
    end
    ...
    def hash
      [user_external_id, subscribe_sdk_client].hash
    end
