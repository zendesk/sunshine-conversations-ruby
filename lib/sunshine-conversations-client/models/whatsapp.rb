  ...
  class Whatsapp < Integration
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_management_access_token == o.account_management_access_token && super(o)
    end
    ...
    def hash
      [type, deployment_id, hsm_fallback_language, account_id, account_management_access_token].hash
    end
