  ...
  class UserMergeEventAllOfPayload
    ...
    def self.openapi_types
      {
        ...
        :'discarded_metadata' => :'Hash<String, Object>',
        :'reason' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'discarded_metadata')
        if (value = attributes[:'discarded_metadata']).is_a?(Hash)
          self.discarded_metadata = value
        end
      end
    ...
    def hash
      [merged_usersmerged_conversationsmerged_clientsdiscarded_metadatareason].hash
    end
