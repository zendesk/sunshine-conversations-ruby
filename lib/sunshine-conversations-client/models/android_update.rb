...
module SunshineConversationsClient
  class AndroidUpdate
    ...
    def hash
      [display_namedefault_responder_idproject_idclient_emailprivate_keyserver_keysender_idcan_user_see_conversation_listcan_user_create_more_conversations].hash
    end
