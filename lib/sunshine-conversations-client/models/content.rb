...
module SunshineConversationsClient
  class Content
    ...
    def hash
      [type, text, html_text, block_chat_input, markdown_text, actions, payload, items, display_settings, media_url, media_size, media_type, alt_text, attachment_id, submitted, fields, text_fallback, coordinates, location, template].hash
    end
