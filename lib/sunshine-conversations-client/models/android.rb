...
module SunshineConversationsClient
  class Android < Integration
    ...
    def hash
      [type, project_id, client_email, private_key, server_key, sender_id, can_user_see_conversation_list, can_user_create_more_conversations, attachments_enabled, default_responder_id, default_responder].hash
    end
