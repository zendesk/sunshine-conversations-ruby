...
module SunshineConversationsClient
  class Android < Integration
    ...
    def hash
      [default_responder_iddefault_respondertypeproject_idclient_emailprivate_keyserver_keysender_idcan_user_see_conversation_listcan_user_create_more_conversationsattachments_enabled].hash
    end
