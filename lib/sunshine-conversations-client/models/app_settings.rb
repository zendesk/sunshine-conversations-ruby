...
module SunshineConversationsClient
  ...
  class AppSettings
    ...
    def hash
      [conversation_retention_secondsmask_credit_card_numbersuse_animal_namesecho_postbackignore_auto_conversation_startmulti_convo_enabledapp_localization_enabled].hash
    end
