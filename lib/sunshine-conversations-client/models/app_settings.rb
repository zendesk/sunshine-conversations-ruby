...
module SunshineConversationsClient
  ...
  class AppSettings
    ...
    def hash
      [conversation_retention_seconds, mask_credit_card_numbers, use_animal_names, echo_postback, ignore_auto_conversation_start, multi_convo_enabled, attachments_access, attachments_token_expiration_seconds].hash
    end
