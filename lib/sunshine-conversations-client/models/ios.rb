...
module SunshineConversationsClient
  class Ios < Integration
    ...
    def hash
      [default_responder_iddefault_respondertypecertificatepasswordproductionauto_update_badgecan_user_see_conversation_listcan_user_create_more_conversationsattachments_enabled].hash
    end
