...
module SunshineConversationsClient
  class Ios < Integration
    ...
    def hash
      [type, certificate, password, production, auto_update_badge, can_user_create_more_conversations, attachments_enabled, default_responder_id, default_responder].hash
    end
