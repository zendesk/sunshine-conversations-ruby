  ...
  class MessagePost
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SunshineConversationsClient::MessagePost` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SunshineConversationsClient::MessagePost`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'message_schema')
        self.message_schema = attributes[:'message_schema']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          metadata == o.metadata &&
          override == o.override &&
          message_schema == o.message_schema
    end
    ...
    def hash
      [author, content, destination, metadata, override, message_schema].hash
    end
