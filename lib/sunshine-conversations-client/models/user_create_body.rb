  ...
  class UserCreateBody
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SunshineConversationsClient::UserCreateBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SunshineConversationsClient::UserCreateBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'to_be_retained')
        self.to_be_retained = attributes[:'to_be_retained']
      end
    ...
    def list_invalid_properties
      ...
      if @external_id.to_s.length > 1024
        invalid_properties.push('invalid value for "external_id", the character length must be smaller than or equal to 1024.')
      end
    ...
    def valid?
      ...
      return false if @external_id.to_s.length > 1024
    ...
    def external_id=(external_id)
      ...
      if external_id.to_s.length > 1024
        fail ArgumentError, 'invalid value for "external_id", the character length must be smaller than or equal to 1024.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          to_be_retained == o.to_be_retained &&
          profile == o.profile &&
          metadata == o.metadata
    end
    ...
    def hash
      [external_id, signed_up_at, to_be_retained, profile, metadata].hash
    end
