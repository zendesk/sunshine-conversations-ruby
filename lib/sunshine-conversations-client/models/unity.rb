  ...
  class Unity < Integration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SunshineConversationsClient::Unity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SunshineConversationsClient::Unity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          default_responder == o.default_responder &&
          type == o.type &&
          ...
          attachments_enabled == o.attachments_enabled && super(o)
    end
    ...
    def hash
      [default_responder_iddefault_respondertypecan_user_see_conversation_listcan_user_create_more_conversationsattachments_enabled].hash
    end
